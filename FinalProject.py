...
ff_tip_target = np.asarray([ 0, 0.0435, -0.001542])
mf_tip_target = np.asarray([ 0, 0, 0.0007])
rf_tip_target = np.asarray([ 0, -0.0435, -0.001542])
th_tip_target = np.asarray([-0.0182, 0.019333, -0.045987])
